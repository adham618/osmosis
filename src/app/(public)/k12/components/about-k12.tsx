        ...
        <div className="container" style={{ paddingTop: '60px' }}>
          <div className="row gap-5 justify-content-between">
            ...
            <div className="col-lg-5 align-self-center align-items-center" data-aos="fade-in">
              ...
              <p className="mb50">
                The Osmosis course platforms offers students from all grade levels the opportunity
                to learn through doing, providing a structured and engaging learning environment
              ...
              <div className="single_about">
                <div className="aicon">
                  <svg fill="none" viewBox="0 0 45 45">
                    ...
                    <g fill="url(#purpleGradient1)" clipPath="url(#clip0_2797_63)">
                ...
                <div className="sbcontent">
                  <h4>Integrated tools to aid retention</h4>
                  <p>
                    Osmosis offers a variety of features adapted to different age groups and
                    learning styles, leaning into a child&apos;s strengths and providing them with
                    the best interface to absorb and retain information.
                  </p>
                </div>
              </div>
              ...
              <div className="single_about">
                <div className="aicon">
                  <svg fill="none" viewBox="0 0 45 45">
                    ...
                    <g fill="url(#purpleGradient2)" clipPath="url(#clip0_2830_402)">
                ...
                <div className="sbcontent">
                  <h4>50+ courses, 12+ subjects</h4>
                  <p>
                    With over 50 courses in over 12 subject areas, we&apos;re here to help bring any
                    classroom to life!
                  </p>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row gap-5 justify-content-between">
            <div className="col-lg-5 align-self-center align-items-center" data-aos="fade-in">
              ...
              <p className="mb50">
                What makes education valuable? It&apos;s about more than just knowing things about
                the world, it&apos;s about understanding why things happen, and cultivating the
                curiosity to find out when we do not. Learning through augmented reality
                doesn&apos;t just provide useful and immediate tools to reinforce and improve
                retention of knowledge, it sparks genuine interest in how things work under the
                hood.
              </p>
